google.maps.__gjsload__('search_impl', function(_) {
    var Izb = function(a, b) {
        ...
        Nzb = function(a, b, c) {
            ...
            _.UZa(c, _.wQ(b));
            b = [];
            b.push(_.Vj(c, "click", Lzb.bind(null, a)));
            for (const e of ["mouseover", "mouseout", "mousemove"]) b.push(_.Vj(c, e, Mzb.bind(null, a, e)));
    ...
    var Kzb = class {
        constructor() {
            var a = _.vn,
                b = _.un;
            this.Eg = _.ni;
            this.fetch = _.Kx.bind(Pzb, a, _.Cz + "/maps/api/js/LayersService.GetFeature", b)
        }
        load(a, b) {
            function c(e) {
                b(new Szb(e))
    ...
    Ozb.prototype.QG = function(a) {
        if (_.xm[15]) {
            var b = a.Cl;
            const c = a.Cl = a.getMap();
            b && a.Eg && (a.Hg ? (b = b.__gm.ck, b.set(b.get().Sn(a.Eg))) : a.Eg && _.v_a(a.Eg, b) && ((a.Fg || []).forEach(_.Xj), a.Fg = null));
            if (c) {
                b = new _.Bw;
                ...
                a.Hg ? (a = c.__gm.ck, a.set(_.zr(a.get(), b))) : Nzb(a, c, b);
                _.Pk(c, "Lg");
                _.L(c, 148282)
            }
        }
    };
    _.Mi("search_impl", new Ozb);
});